...
for file in "${FILES[@]}"; do
    [ -f "$PROJECT_DIR/$file" ] || { echo "❌ ملف مفقود: $file"; exit 1; }
done
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " FAKE GPS WFX v$VERSION — iOS $MIN_IOS إلى iOS $MAX_TARGET_IOS"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
EOF
    ...
    # umask 077 creates package directories as 0700. dpkg-deb requires
    # the DEBIAN control directory to be between 0755 and 0775.
