...
@property (nonatomic, copy) NSArray<NSNumber *> *scheduleWeekdays;
@property (nonatomic, assign) NSInteger scheduleStartMinutes;
@property (nonatomic, assign) NSInteger scheduleEndMinutes;
@property (nonatomic, assign) long long scheduleLocationID;
@property (nonatomic, assign) BOOL scheduleApplied;
@property (nonatomic, assign) BOOL scheduleDraftDirty;

// The committed schedule is the only schedule evaluated by the timer.
@property (nonatomic, assign) BOOL committedScheduleEnabled;
@property (nonatomic, copy) NSArray<NSNumber *> *committedScheduleWeekdays;
@property (nonatomic, assign) NSInteger committedScheduleStartMinutes;
@property (nonatomic, assign) NSInteger committedScheduleEndMinutes;
@property (nonatomic, assign) long long committedScheduleLocationID;
