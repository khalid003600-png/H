...
expect_pattern "تثبيت هوك CLLocationManager.location" 'WFInstallInstanceHook\(CLLocationManager.class' WolFoxIntegrated.mm
expect_pattern "تثبيت هوك CLLocation.coordinate" 'WFInstallInstanceHook\(CLLocation.class' WolFoxIntegrated.mm
...
expect_pattern "تحديث المسار بالمعدل المحفوظ" 'scheduledTimerWithTimeInterval:WFClampGPSUpdateInterval' WolFoxProHookManager.m
